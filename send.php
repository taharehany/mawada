...
<body>
   <div class="main-wrapper">
                  ...
                  <ul class="navbar-nav">
                     ...
                     <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink1" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">اللغة</a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink1">
                           <li><a class="dropdown-item" href="https://mawada.agency/">الإنجليزية</a></li>
                        </ul>
                     </li>
                  </ul>
               </div>
      ...
      <footer>
               ...
               <div class="row">
                  <div class="col-lg-5">
                     <div class="footer-box">
                        <h3>من نحن</h3>
                        <div class="about">
                           <p>نحن فريق تسويق رقمي متميز وبخبرة مع أكثر من 40 شركة في الخليج العربي بإستهداف لغالبية دول العالم العربي والغربي وفي الكثير من المجالات والصناعات المختلفة. بإستهداف
         ...
         <div class="copyright">
            <div class="copy-text">
               <p>جميع الحقوق محفوظة &copy;<a href="https://mawada.agency/">مودة للتسويق الإلكتروني.</a></p>
            </div>
         </div>
      </footer>
      <!--footer part-->
